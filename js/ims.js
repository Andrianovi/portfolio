window.addEventListener('load', function () {
	...
	let siteName = `Вёрстка сайтов`;
	let siteTitle = 'Адаптив под любой размер экрана, оптимизация под слабый интернет, анимация движений объектов, изменения размеров, надёжная вёрстка';
